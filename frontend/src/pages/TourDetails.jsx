              ...
              <div className="tour__content">
                ...
                <div className="tour__info">
                  ...
                  <span className="tour__rating d-flex align-items-center gap-1">
                    ...
                    {totalRating===0?('Unrated'):(<span>({reviews?.length})</span>)} 
                  </span>
                    <span>
                    ...
                    <div className="tour__extra-details">
                      ...
                      <span><i className='ri-money-dollar-circle-line'></i>${price}/per head</span>
                ...
                <div className="tour__reviews mt-4">
                  ...
                  <Form onSubmit={submitHandler}>
                    ...
                    <div className="review__input"><input type="text" ref={reviewMsgRef} placeholder='share your thoughts' required />
                          ...
                          <div className='w-100'>
                            <div className='d-flex align-items-center justify-content-between'>
                              <div>
                                ...
                                <p>
                                  {new Date("07-20-2024").toLocaleDateString('en-US',options
                                    )}
                                  </p>
                              </div>
